const wdComponentCode = new Map([
    ...
    ["radio-input", `<input type="radio" class="wd-component wd-input-radio" name="name" value="option"><label  class="wd-component wd-input-radio-label" for="option">option</label><br>`, `.wd-input-radio-label{color:#000; width: 3rem; height: 2rem ; background-color:rgba(255,255,255,1); font-size: 1rem; font-weight: normal; font-style: none; font-family:default; text-align:left; text-decoration:none;}`],
    ["checkbox-input", `<input type="checkbox" class="wd-component wd-input-checkbox"  name="name"><label  class="wd-component wd-input-checkbox-label for="option">option</label><br>`, `.wd-input-checkbox-label{color:#000; width: 3rem; height: 2rem ;background-color:rgba(255,255,255,1); font-size: 1rem; font-weight: normal; font-style: none; font-family:default; text-align:left; text-decoration:none;}`],
